...
PL_ch4nm = [((491, 608), (255, 255, 255)), ((493, 723), (255, 182, 0)), ((488, 824), (255, 255, 255)), ((1418, 154), (255, 182, 0))]
...
PL_map1 = [((682, 495), (255, 255, 255)), ((686, 175), (255, 255, 255)), ((1029, 383), (255, 239, 181)), ((973, 777), (156, 181, 74))]

click_heli = (((1365, 856), (37, 37), 37), 1, 1, False)
click_command = (((1396, 220), (28, 28), 28), 0.5, 1, False)
click_command_dshort = (((1396, 220), (28, 28), 28), 0.2, 0.3, False)
...
PL_mapStarted = [((687, 383), (255, 255, 255)), ((560, 186), (214, 105, 24)), ((276, 898), (255, 255, 255))]
...
PL_dragged = [((771, 220), (255, 255, 255)), ((990, 255), (255, 255, 255)), ((561, 532), (238, 190, 116)), ((569, 189), (214, 105, 24))]

node1 = (((1169, 196), (24, 24), 24), 0.4, 0.3, False)
node2 = (((989, 256), (23, 23), 23), 0.4, 0.3, False)
node3 = (((772, 221), (23, 23), 23), 0.4, 0.3, False)
node4 = (((542, 255), (37, 37), 37), 0.8, 0.3, False)
PL_n1 = [((1183, 228), (255, 186, 0))]
PL_n2 = [((1006, 285), (255, 186, 0))]
PL_n3 = [((775, 189), (255, 186, 0))]
PL_n4 = [((550, 288), (255, 186, 0))]
...
PL_ended = [((1169, 196), (255, 0, 0)), ((988, 256), (255, 255, 255)), ((771, 220), (255, 255, 255)), ((1046, 615), (222, 178, 114))]
...
def randomMapDrag():
    return ((randPoint((1072, 232), (188.5, 91.0)), randPoint((1092, 826), (191.5, 84.0)), 150, normalRange(0.45, 0.15)), 0.5, 0.5, True)
...
def runMap(firstOrder):
    ...
    runSequence([PL_map1, click_heli, PL_echChoose, deployOk, PL_map1, randomMapDrag(), PL_dragged, click_command, PL_echChoose, deployOk, PL_dragged])

    #start, resupply, planning, select heli, scroll
    runSequence([PL_dragged, startMap, PL_mapStarted, click_command_dshort, PL_mapStarted, click_command, PL_resupply, resupply, PL_mapStarted, planning, PL_planning])
...
def retreat(gunPos):
    if checkPixels(PL_battle):
        positionSelected(*posGrid[gunPos])
        wait(0.1, 0.05)
    if checkPixels(PL_battle):
        withdraw()
        wait(0.1, 0.05)
